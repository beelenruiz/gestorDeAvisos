<div>
    <x-button wire:click="$set('openCreate', true)"><i class="fas fa-add mr-2"></i>nueva empresa</x-button>
    ...
    <x-dialog-modal wire:model="openCreate">
        ...
        <x-slot name="content">
            ...
            <div>
                ...
                <x-input type="text" wire:model="cform.phone" name="phone" id="phone"></x-input>
                <x-input-error for="cform.phone" />
            </div>
        </x-slot>
